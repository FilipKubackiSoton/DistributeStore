...
private static final String LOG_FILE_SUFFIX = "dstore";
	...
	public static void init(Logger.LoggingType loggingType, int port) throws IOException {
		if (instance == null)
	...
	protected DstoreLogger(Logger.LoggingType loggingType, int port) throws IOException {
		super(loggingType);
